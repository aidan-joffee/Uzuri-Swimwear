...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="body-flexbox">
        ...
        <div style="padding-top: 10px;">
            <asp:Button runat="server" ID="CheckOutBtn" OnClick="CheckOutBtn_Click" class="btn btn-primary btn-lg" style="background-color:gold; color:black; border-color:gray;" Text="Proceed to checkout" />
        </div>
