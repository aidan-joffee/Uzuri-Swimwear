<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/UzuriSwimwear.Master" AutoEventWireup="true" CodeFile="CartForm.aspx.cs" Inherits="Uzuri_Swimwear.Forms.CartForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="body-flexbox">
        ...
        <div style="padding-top: 10px;">
            <button type="button" class="btn btn-primary btn-lg" style="background-color:gold; color:black; border-color:gray; ">Proceed to order form</button>
        </div>
