...
using System.Web;
using Uzuri_Swimwear;
using Uzuri_Swimwear.Model;
using System.Collections.Generic;
using System.Linq;
using System.Data.Entity.Core.Objects;

namespace Uzuri_Swimwear.Forms.Logic
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "sb-p4s648816071_api1.business.example.com";
        private string APIPassword = "DAZ8W7G4RS8EUKGD";
        private string APISignature = "AX5pcbgVh2sTkrRKNWWwLJmuASacA1RG2qjlNu2.l8j860tiWVsNY79k";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44329/Checkout/CheckoutReview.aspx";
            string cancelURL = "https://localhost:44329/Checkout/CheckoutCancel.aspx";
            ...
            {
                string userID = "d38ee9aa-f69e-4ee4-9826-3466f51845b9";

                IEnumerable<GetOrderProducts_Result> myOrderList = dbContext.GetOrderProducts(userID);

                foreach(var order in myOrderList)
                {
                    encoder["L_PAYMENTREQUEST_0_NAME"] = order.NAME;
                    encoder["L_PAYMENTREQUEST_0_AMT"] = Convert.ToString(order.PRICE);
                    encoder["L_PAYMENTREQUEST_0_QTY"] = "1";
                }
